        ...
        <section className='problem' id='why-cycle'>
            ...
            <div className='problemBoxes'>
                <div className='problemBox'>
                    <img className="problemImg" src={shield} alt="Security shield" width="33" height="33"/>
                    <h3 className='problemTitle'>Feeling Unsafe Alone</h3>
                    <p className='problemDsc'>Riding alone can <br /> feel intimidating, <br /> especially on <br /> unfamiliar routes <br /> or at night.</p>
                </div>

                <div className='problemBox'>
                    <img className="problemImg" src={deal} alt="Security deal" width="33" height="33"/>
                    <h3 className='problemTitle'>Hard to Meet <br /> Cycling Partners</h3>
                    <p className='problemDsc'>It isn't always easy to  <br />find friends or people <br /> with similar schedules <br /> who want to ride.</p>
                </div>

                <div className='problemBox'>
                    <img className="problemImg" src={bricks} alt="Security bricks" width="33" height="33"/>
                    <h3 className='problemTitle'>Psychological Barriers</h3>
                    <p className='problemDsc'>Many people <br />hesitate because <br />they lack confidence, <br />experience, or <br />motivation.</p>
                </div>

                <div className='problemBox'>
                    <img className="problemImg" src={authenticity} alt="Security authenticity" width="33" height="33"/>
                    <h3 className='problemTitle'>Cycling Benefits Are <br />Often Overlooked</h3>
